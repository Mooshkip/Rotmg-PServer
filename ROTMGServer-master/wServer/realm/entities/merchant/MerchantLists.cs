...
//Rings t4
{0xa1f, new Tuple<int,CurrencyType>(0, CurrencyType.Fame)}, //Defense
{0xa20, new Tuple<int,CurrencyType>(0, CurrencyType.Fame)}, //Attack
...
{0xae9, new Tuple<int,CurrencyType>(0, CurrencyType.Fame)}, //Health
{0xaea, new Tuple<int,CurrencyType>(0, CurrencyType.Fame)}, //Magic
